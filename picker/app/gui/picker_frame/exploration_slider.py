...
class ExplorationSlider(tk.Frame):
    def __init__(self, predictor_widget: PredictionDisplay | None = None, master=None):
        ...
        slider_label = ttk.Label(self, text="No prefs")
        slider_label.grid(column=0, row=0, padx=(0, 5))

        # The slider itself - make it shorter
        ...
        slider_label_2 = ttk.Label(self, text="Strong prefs")
        slider_label_2.grid(column=2, row=0, padx=(5, 0))
